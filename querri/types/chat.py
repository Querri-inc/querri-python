...
class Message(BaseModel):
    ...
    created_at: str | None = None  #: ISO-8601 timestamp of the message.
...
class Chat(BaseModel):
    ...
    project_id: str | None = None  #: Parent project ID.
    name: str = ""  #: Display name of the chat.
    message_count: int | None = None  #: Total messages in the chat.
    messages: list[Message] | None = None  #: Only on detail responses.
...
class ChatCancelResponse(BaseModel):
    ...
    reason: str | None = None  #: Reason for cancellation, if provided.
